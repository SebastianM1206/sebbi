  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-white">
      <Card className="w-full max-w-md p-8 border-0 shadow-none">
        ...
        <Button
          variant="outline"
          className="w-full flex items-center justify-center gap-2 mb-4 border text-base font-medium"
        >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <a
                ...
                className="absolute right-0 -bottom-6 text-sm underline text-blue-600"
